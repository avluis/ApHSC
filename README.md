...
# Goals (in order of implementation):
	...
	Blink current selected Heat level when indicating				[TESTING]
	Don't turn on main power (status pin) when indicating			[TESTING]
	Modify auto start heat level saving to always save				[TESTING]
